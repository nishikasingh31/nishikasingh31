...
- **[Interview Prep AI](https://github.com/nishikasingh31/Interview-Prep-AI)** </br>
  → AI-powered interview practice platform that generates role-specific questions, evaluates answers, and tracks history using LLM integration.</br>
...
- **[Handwritten Digit Classification using CNN](https://github.com/nishikasingh31/Handwritten-Digit-Classification-using-CNN)**  
